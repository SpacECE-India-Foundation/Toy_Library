...
<html>
	...
	<body><div class="container-fluid">
		<div class="row">
			...
			<div class="offset-sm-5 col-sm-3 "><br><p style="color:white; font-size:40px;"><br>Customer Login</style></div>
		</div>
	</div><br>
	...
	<br><br><br>
		<div class="container">
		<div class="row">
		<div class="offset-sm-4 col-sm-1"><img src="img55.png" width="80px" height="80px"></div>
		<div class="col-sm-3"><br><h3><p style="color:white; padding-left:10px;">Login here</style></h3></div>
		<div class="w-100"></div>
...
<?php	
	...
	if(isset($_REQUEST['but']))
	{
		...
		else
		{
			...
			$con=mysqli_connect("localhost","root","","farmmarketing");
			$name=$_REQUEST["na"];
			$pass=$_REQUEST["pa"];
	
			$s="select * from cust_reg where username='$name' && password='$pass' ";
